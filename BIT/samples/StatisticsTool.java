	...
	public static void doDynamic(File in_dir, File out_dir) 
		{
			...
			for (int i = 0; i < filelist.length; i++) {
				String filename = filelist[i];
				classname = filename.substring(0, filename.length()-6) + ".txt";
				if (filename.endsWith(".class")) {
					String in_filename = in_dir.getAbsolutePath() + System.getProperty("file.separator") + filename;
					...
					ci.addAfter("StatisticsTool", "printDynamic", classname);
    ...
    public static synchronized void printDynamic(String foo) 
		{
			...
			try{
                FileWriter myWriter = new FileWriter(foo);
                myWriter.write("Dynamic information summary:\n");
                myWriter.write("Number of methods:      " + dyn_method_count + "\n");
                myWriter.write("Number of basic blocks: " + dyn_bb_count+ "\n");
                myWriter.write("Number of instructions: " + dyn_instr_count+ "\n");
